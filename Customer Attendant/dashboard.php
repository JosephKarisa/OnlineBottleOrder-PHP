...
<head>
    ...
    <title>Customer Attendant</title>
            ...
            <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Customer Attendant Dashboard</h4>
                            </div>
                     <div class="row">
                    ...
                    <div class="col-md-3">
					 ...
					 <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                    <span><i class="fas fa-wine-bottle f-s-40 " aria-hidden="true"></i></span>
                                </div>
                                <div class="media-body media-text-right">
