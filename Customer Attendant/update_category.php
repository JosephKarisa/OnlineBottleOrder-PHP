...
<body class="fix-header">
    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                       ...
                       <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Bottles/Jars</span></a>
                            <ul aria-expanded="false" class="collapse">
        ...
        <div class="page-wrapper">
					 ...
					 <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Update Productt Category</h4>
                            </div>
                            <div class="card-body">
            ...
            <footer class="footer"> © 2022 - Online Bottles Ordering System </footer>
