...
<body class="home">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="http://localhost/OnlineBottleOrder-PHP/Customer%20Attendant/index.php">Attendant Login <span class="sr-only"></span></a> </li>
                           
							<?php
						if(empty($_SESSION["user_id"])) // if user is not login
							{
								echo '<li class="nav-item"><a href="login.php" class="nav-link active">Customer Login</a> </li>
        ...
        <section class="hero bg-image" data-image-src="https://media.istockphoto.com/photos/the-stock-of-the-pet-bottles-in-the-warehouse-waiting-for-drinking-picture-id1190548760?k=20&m=1190548760&s=612x612&w=0&h=7fj30PTgNjgE40A-keVmrNZvWta9Lr_CsXqmsFh0Nys=">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Welcome to the official Website of SafePak Limited </h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Choose Product</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>Add to Cart and Pay</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;">3. </span>Await Delivery</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Most ordered products this Month</h2>
                    <p class="lead">Easiest way to order down below</p>
                </div>
                <div class="row">
						<?php 					
            ...
            <div class="container">
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We"ve got your covered with a variety of barrels from our warehouse.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <p>We"ve got your covered with a variety of products to choose from.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Pay and await Delivery</h3>
                                <p>Get your products in good time </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Delivery after Payment</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>1086 Ndemi Road Kilimani</p>
                                    <h5>Phone: 0722 335 417</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>Join thousands of other supplierss who benefit from having partnered with us.</p>
                                </div>
                    </div>
                </div>
